...
public class AgendaController {
	...
	public static String removePessoa(int id) {
		...
		return nomeDaPessoaRemovida + " removido da agenda";
		}
	...
	public static String alteraInformacao(int id) throws IOException {
		...
		if (pessoa2 == null) {
			...
			if (opcaoMenuDeAlteracao == 0) {
    	 	...
    	 	}else if(opcaoMenuDeAlteracao == 5) {
				System.out.println("Celular: ");
				celular = ler.next();
				pessoa2.setCelular(celular);
			}
		}
	...
	public static int menuDeAlteraCao() {
		...
		do {
			...
			System.out.println("    |     3 - Alterar nascimento |");
			System.out.println("    |     4 - Alterar e-mail     |");
			System.out.println("    |     5 - Alterar celular    |");
	...
	public static int menuDePesquisa() {
		...
		do {
			...
			System.out.println("    |     3 - Pesquisar com telefone |");
			System.out.println("    |     0 - Sair                   |");
			System.out.println("    ===============================\n");
			System.out.print("\nOpção -> ");
			opcao = ler.nextInt();
